...
# Remove bad data for HR
overview_HR <- phys_data %>% 
  group_by(file) %>% 
  summarise(
    sum(duplicated(HR1)),
    sum(duplicated(HR2)))
...
phys_data <- phys_data %>% 
  mutate(
    HR_change1 = (HR1_future - HR1),
    HR_change2 = (HR2_future - HR2),
    Resp_change1 = (Resp1_future - Resp1),
    Resp_change2 = (Resp2_future - Resp1)
  )
